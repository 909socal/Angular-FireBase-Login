app.factory('fbRef', function($window) {
  return new $window.Firebase('https://authmetes.firebaseio.com/');
});
...
app.service('Chat', function(fbRef, $firebaseObject) {
  this.makeChatroom = function(){
    console.log('')
    var chatref = fbRef.child('chat').child('1').set('hi');
  }
})  


//whole new service list
